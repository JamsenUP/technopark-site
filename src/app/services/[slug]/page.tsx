...
const SERVICE_CONTENT = {
  construction: {
    ...
    description:
      "Организуем утилизацию строительного мусора с частных объектов и стройплощадок. Предоставляем контейнеры 8–27 м³, самосвалы и погрузку.",
  ...
  household: {
    ...
    description:
      "Утилизация крупногабаритного и бытового мусора во дворах, на территориях ЖК и коммерческих объектах. Работаем разово и по абонентским договорам.",
    imageUrl: null as string | null,
    variants: [
      "Разовая утилизация КГО по заявке УК или ТСЖ",
      "Регулярная утилизация по графику",
  ...
  bulky: {
    ...
    imageUrl: null as string | null,
    variants: [
      "Утилизация мебели и интерьера при переездах",
      "Демонтаж и утилизация торгового оборудования",
      "Утилизация металлоконструкций и нестандартных грузов",
    ],
  },
  snow: {
    title: "Утилизация снега",
    description:
      "Уборка и утилизация снега с территорий, парковок, складских и промышленных площадок. Работаем ночью и в выходные.",
    imageUrl: null as string | null,
    variants: [
      "Разовая утилизация снега после обильных осадков",
      "Сезонное обслуживание территорий",
      "Уборка спецтехникой с последующей утилизацией",
    ],
  },
  "flat-office": {
    title: "Утилизация мусора из квартир и офисов",
    description:
      "Комплексная утилизация мусора из квартир, офисов и складов после ремонта, переезда или ликвидации.",
    imageUrl: null as string | null,
    variants: [
      "Утилизация после ремонта квартиры или офиса",
      "Освобождение помещений под сдачу или продажу",
      "Утилизация стеллажей, мебели и архивов",
    ],
  },
  hazardous: {
    title: "Утилизация опасных отходов (I–IV класс)",
    description:
      "Сбор и утилизация опасных отходов по лицензии. Обеспечиваем полное соответствие требованиям законодательства.",
    imageUrl: null as string | null,
    variants: [
      "Разработка схемы обращения с отходами",
      "Утилизация по утвержденному графику",
  ...
  containers: {
    ...
    variants: [
      ...
      "Индивидуальные условия по тарифам и графику утилизации",
    ],
  },
} as const;
  ...
  return (
    <SiteLayout>
      <Section
        ...
        subtitle="Подберем подходящий формат утилизации и предложим прозрачный тариф под ваш объем и график."
      >
